...
// Min value and any larger value must be covered.
func Min(x, min int) int { return x }

// MinInt8 value and any larger value must be covered.
func MinInt8(x, min int8) int8 { return x }

// MinInt16 value and any larger value must be covered.
func MinInt16(x, min int16) int16 { return x }

// MinInt32 value and any larger value must be covered.
func MinInt32(x, min int32) int32 { return x }

// MinInt64 value and any larger value must be covered.
func MinInt64(x, min int64) int64 { return x }

// MinUint value and any larger value must be covered.
func MinUint(x, min uint) uint { return x }

// MinUint8 value and any larger value must be covered.
func MinUint8(x, min uint8) uint8 { return x }

// MinUint16 value and any larger value must be covered.
func MinUint16(x, min uint16) uint16 { return x }

// MinUint32 value and any larger value must be covered.
func MinUint32(x, min uint32) uint32 { return x }

// MinUint64 value and any larger value must be covered.
func MinUint64(x, min uint64) uint64 { return x }

// MinUintptr value and any larger value must be covered.
func MinUintptr(x, min uintptr) uintptr { return x }

// MinMax requires that minimum value, maximum value and any value between them
// must be covered.
func MinMax(x, min, max int) int { return x }

// MinMaxInt8 requires that minimum value, maximum value and any value between
// them must be covered.
func MinMaxInt8(x, min, max int8) int8 { return x }

// MinMaxInt16 requires that minimum value, maximum value and any value between
// them must be covered.
func MinMaxInt16(x, min, max int16) int16 { return x }

// MinMaxInt32 requires that minimum value, maximum value and any value between
// them must be covered.
func MinMaxInt32(x, min, max int32) int32 { return x }

// MinMaxInt64 requires that minimum value, maximum value and any value between
// them must be covered.
func MinMaxInt64(x, min, max int64) int64 { return x }

// MinMaxUint requires that minimum value, maximum value and any value between
// them must be covered.
func MinMaxUint(x, min, max uint) uint { return x }

// MinMaxUint8 requires that minimum value, maximum value and any value between
// them must be covered.
func MinMaxUint8(x, min, max uint8) uint8 { return x }

// MinMaxUint16 requires that minimum value, maximum value and any value
// between them must be covered.
func MinMaxUint16(x, min, max uint16) uint16 { return x }

// MinMaxUint32 requires that minimum value, maximum value and any value
// between them must be covered.
func MinMaxUint32(x, min, max uint32) uint32 { return x }

// MinMaxUint64 requires that minimum value, maximum value and any value
// between them must be covered.
func MinMaxUint64(x, min, max uint64) uint64 { return x }

// MinMaxUintptr requires that minimum value, maximum value and any value
// between them must be covered.
